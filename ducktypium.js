...
class Ducktypium {
  ...
  refract(refColor) {
    if (
      (this.color === "red" && refColor === "blue") ||
      (this.color === "blue" && refColor === "red")
    ) {
      return "purple";
    } else if (
      (this.color === "red" && refColor === "yellow") ||
      (this.color === "yellow" && refColor === "red")
    ) {
      return "orange";
    } else if (
      (this.color === "yellow" && refColor === "blue") ||
      (this.color === "blue" && refColor === "yellow")
    ) {
      return "green";
